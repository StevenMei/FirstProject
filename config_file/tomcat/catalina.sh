...
JAVA_OPTS="-Xms3g -Xmx3g -Xmn1g -Xss256k -XX:PermSize=256m -XX:MaxPermSize=256m -XX:+UseConcMarkSweepGC -XX:+UseCMSCompactAtFullCollection -XX:CMSFullGCsBeforeCompaction=0 -XX:+CMSConcurrentMTEnabled -XX:+UseParNewGC -XX:-OmitStackTraceInFastThrow -XX:+HeapDumpOnOutOfMemoryError"
